	...
	<div id="all">
		...
		<div id="menu1">
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath }/OrderServlet?method=putDiningCar&food_id=${requestScope.food.id}" style="background:url(${pageContext.request.contextPath }/app/detail/style/images/img/order_left_corner_bg.png);">放入餐车</a>
		...
		<div id="dish_class">
			...
			<div id="dish_2">
				<ul>
					...
					<c:if test="${not empty requestScope.foodTypes }">
						<c:forEach var="item" items="${requestScope.foodTypes }">
							<li>
