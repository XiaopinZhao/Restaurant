		...
		<div id="index_center">
			...
			<div id="center_bottom">
				<ul style=" display:inline-table">
					<c:if test="${not empty applicationScope.table }">
					<c:forEach var="item" items="${applicationScope.table }">
							<c:choose>
								<c:when test="${item.tableStatus==0 }">
										<li>
											<a href="${pageContext.request.contextPath }/IndexServlet?method=getMenu&table_id=${item.id}">
												${item.tableName }&nbsp;
											</a>
										</li>
									</c:when>
