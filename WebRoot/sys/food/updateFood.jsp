...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/FoodServlet?method=updateFood&id=${requestScope.food.id}" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
                            ...
                            <select name="foodType_id" style="width:80px">
                            	<c:if test="${ not empty requestScope.foodTypeList }">
                            		<c:forEach var="item" items="${requestScope.foodTypeList }">
                            			<c:choose>
                            				<c:when test="${requestScope.food.foodType_id==item.id }">
                             ...
                             *<input type="hidden" name="iddd" value="1" /></td>
						</tr>
						<tr>
							<td width="80px">菜名</td>
